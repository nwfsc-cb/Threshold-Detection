...
pdf("figurepdfs/Cov_bxpt_linexp_test.pdf", width = 5, height = 6)
par(mfrow = c(4, 2))
layout(matrix(c(1, 3, 5, 7, 2, 4, 6, 7), nrow = 4, ncol = 2), widths = c(1, 1), heights = c(1, 1, 1, 0.3))
#layout.show(10)
#par(mar=c(0, 1.5, 0.5, 0), oma = c(0, 2, 3, 3))
...
legend(x = "bottomright", legend = c("x", expression(x~+~x[2])), col = "gray30", pch = c(1, 16), title = "Variables in model", ncol = 2)
