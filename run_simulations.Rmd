...
#df_tmp <- read.csv("simulation outputs0/focal_results.csv")

#jdf <- df_tmp %>% filter(shape == "skew") %>% select(-X, -shape, -best_mod, -aic_diff)
...
#jdf <- df_tmp %>% filter(shape == "sigmoidal") %>% select(-X, -shape, -best_mod, -aic_diff)
...
# previously saved jdf
#df_tmp <- read.csv("simulation outputs0/lin_cov.csv")

#cov_jdf <- df_tmp %>% filter(shape == "skew") %>% select(-X, -shape, -best_mod, -aic_diff)
...
#cov_jdf <- df_tmp %>% filter(shape == "sigmoidal") %>% select(-X, -shape, -best_mod, -aic_diff)
...
#cov_jdf <- df_tmp %>% filter(shape == "hockeystick") %>% select(-X, -shape, -best_mod, -aic_diff)
...
#cov_jdf <- df_tmp %>% filter(shape == "linear") %>% select(-X, -shape, -best_mod, -aic_diff)
...
# previously saved jdf
#df_tmp <- read.csv("simulation outputs0/exp_cov.csv")
...
# previously saved jdf
#df_tmp <- read.csv("simulation outputs0/lin_cov0.csv")
...
# previously saved jdf
#df_tmp <- read.csv("simulation outputs0/exp_cov0.csv")
...
# previously saved jdf
#df_tmp <- read.csv("simulation outputs0/nonfocal_results.csv")

#jdf <- df_tmp %>% filter(shape == "step") %>% select(-X, -shape, -best_mod, -aic_diff)
